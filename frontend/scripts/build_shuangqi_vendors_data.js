...
function parseArgs() {
  ...
  const out = { xlsx: '', out: path.join(process.cwd(), 'src/data/shuangqiVendors.js'), sheet: '' }
...
function main() {
  ...
  fs.writeFileSync(out, `export const shuangqiVendorsData = ${JSON.stringify(data, null, 2)}\n`, 'utf8')
}
