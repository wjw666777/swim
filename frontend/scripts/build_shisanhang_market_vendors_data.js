...
function parseArgs() {
  ...
  const out = { xlsx: '', out: path.join(process.cwd(), 'src/data/shisanhangMarketVendors.js'), sheet: '' }
...
function main() {
  ...
  fs.writeFileSync(out, `export const shisanhangMarketVendorsData = ${JSON.stringify(data, null, 2)}\n`, 'utf8')
}
