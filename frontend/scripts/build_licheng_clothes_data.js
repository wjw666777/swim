...
function parseArgs() {
  ...
  const out = { xlsx: '', out: path.join(process.cwd(), 'src/data/lichengClothes.js'), sheet: '' }
...
function main() {
  ...
  fs.writeFileSync(out, `export const lichengClothesData = ${JSON.stringify(data, null, 2)}\n`, 'utf8')
}
