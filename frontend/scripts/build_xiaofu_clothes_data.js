...
function parseArgs() {
  ...
  const out = { xlsx: '', out: path.join(process.cwd(), 'src/data/xiaofuClothes.js'), sheet: '' }
...
function main() {
  ...
  fs.writeFileSync(out, `export const xiaofuClothesData = ${JSON.stringify(data, null, 2)}\n`, 'utf8')
}
