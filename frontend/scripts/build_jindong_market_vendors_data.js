...
function parseArgs() {
  ...
  const out = { xlsx: '', out: path.join(process.cwd(), 'src/data/jindongMarketVendors.js'), sheet: '' }
...
function main() {
  ...
  fs.writeFileSync(out, `export const jindongMarketVendorsData = ${JSON.stringify(data, null, 2)}\n`, 'utf8')
}
