...
function parseArgs() {
  ...
  const out = { xlsx: '', out: path.join(process.cwd(), 'src/data/yongheClothes.js'), sheet: '' }
...
function main() {
  ...
  fs.writeFileSync(out, `export const yongheClothesData = ${JSON.stringify(data, null, 2)}\n`, 'utf8')
}
