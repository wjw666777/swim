<template>
  <div class="container">
    ...
    <MenuDrawer v-model:visible="menuOpen" current="jindongMarket" />
...
import { jindongMarketVendorsData } from '../data/jindongMarketVendors.js'

const STORAGE_KEY = 'jindong_market_vendors_companies'
const STATUS_KEY = 'jindong_market_vendors_status'
const NOTES_KEY = 'jindong_market_vendors_notes'
...
onMounted(() => {
  ...
  try {
    companies.value = (jindongMarketVendorsData && jindongMarketVendorsData.length)
      ? jindongMarketVendorsData.map((r, i) => ({
        id: String(i + 1),
        name: r.company || '',
        boss: r.boss || '',
        address: r.address || '',
