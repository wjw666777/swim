  ...
  <div class="container">
    ...
    <a-drawer v-model:visible="menuOpen" placement="right" width="240" :footer="false">
      ...
      <a-space direction="vertical" fill>
        ...
        <a-button long type="primary" @click="go('/zhejiang')">浙江泳装 CRM</a-button>
        <a-button long @click="go('/liaoning')">辽宁泳装 CRM</a-button>
...
import { zhejiangSwimData } from '../data/zhejiangswim.js'
import MenuDrawer from '../components/MenuDrawer.vue'

const STORAGE_KEY = 'zhejiang_swim_companies'
const STATUS_KEY = 'zhejiang_swim_status'
const NOTES_KEY = 'zhejiang_swim_notes'
...
onMounted(() => {
  ...
  try {
    companies.value = (zhejiangSwimData && zhejiangSwimData.length)
      ? zhejiangSwimData.map((r, i) => ({
        id: String(i + 1),
        name: r.company || '',
        boss: r.boss || '',
        address: r.address || '',
