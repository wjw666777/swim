  ...
  <div class="container">
    ...
    <a-drawer v-model:visible="menuOpen" placement="right" width="240" :footer="false">
      ...
      <a-space direction="vertical" fill>
        ...
        <a-button long type="primary" @click="go('/liaoning')">辽宁泳装 CRM</a-button>
        <a-button long @click="go('/zhejiang')">浙江泳装 CRM</a-button>
        <a-button long @click="go('/jinjiang')">晋江服装 CRM</a-button>
        <a-button long @click="go('/shishi')">石狮服装 CRM</a-button>
        ...
        <a-button long @click="go('/wholesale')">库存 CRM</a-button>
      </a-space>
    </a-drawer>
  </div>
</template>
...
import { liaoningSwimData } from '../data/liaoning_swim.js'
import MenuDrawer from '../components/MenuDrawer.vue'

const STORAGE_KEY = 'liaoning_swim_companies'
const STATUS_KEY = 'liaoning_swim_status'
const NOTES_KEY = 'liaoning_swim_notes'
...
onMounted(() => {
  ...
  try {
    companies.value = (liaoningSwimData && liaoningSwimData.length)
      ? liaoningSwimData.map((r, i) => ({
        id: String(i + 1),
        name: r.company || '',
        boss: r.boss || '',
        address: r.address || '',
